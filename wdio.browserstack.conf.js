...
export const config = {
  ...
  baseUrl: `https://fcp-sfd-doc-upload-api-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `fcp-sfd-doc-upload-api-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `fcp-sfd-doc-upload-api-tests-${process.env.ENVIRONMENT}`
        },
